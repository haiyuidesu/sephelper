...
def find_function(seg_start, seg_end):
  function = [
    ...
    ("_DEROiCompare", "a1 01 00 b4  02 05 40 f9"),
    ...
    ("_DERImg4Decode", "61 03 00 54  88 26 40 a9"),
    ("__parse_chain", "5a 3d 00 12  77 3d 00 12"),
    ("_image4_load", "14 00 00 14  a0 6c A7 52"),
