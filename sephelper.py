...
def find_function(seg_start, seg_end):
  ...
  function64(seg_start, seg_end, "_DERParseBitString", "08 00 80 d2  5f 00 00 39")
  function64(seg_start, seg_end, "_DERImg4DecodePayload", "33 03 00 b4  09 01 40 f9")
  function64(seg_start, seg_end, "_DERImg4DecodeProperty", "e8 07 40 b9  08 09 43 b2")
  function64(seg_start, seg_end, "_DERDecodeSeqContentInit", "09 04 40 f9  08 01 09 8b")
  function64(seg_start, seg_end, "_DERImg4DecodeFindProperty", "00 00 80 52  a8 0a 43 b2")
  ...
  function64(seg_start, seg_end, "_ccn_sub", "84 00 04 eb  40 00 00 b5")
